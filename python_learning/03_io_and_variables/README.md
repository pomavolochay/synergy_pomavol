...
Решения двух задач посвященных вводу/выводу, а также переменным с улучшениями в стиле production-подхода: валидация ввода, декомпозиция на функции и покрытие тестами.
